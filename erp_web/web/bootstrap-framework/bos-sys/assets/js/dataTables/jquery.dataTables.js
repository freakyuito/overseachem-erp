...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 *    'display index' if you have hidden data 实体
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to readily specify the 实体 in the length drop
		 ...
		 * (i.e. "Showing 1 to 10 of 57 实体") DataTables will render large numbers
		 ...
		 * the page number, so if you have 10 记录每页 and want to start on
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Showing _START_ to _END_ of _TOTAL_ 实体
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfo": "显示从 _START_ 到 _END_ 的 _TOTAL_ 条数据项",
			 ...
			 *  @type string
			 *  @default Showing 0 to 0 of 0 实体
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ total 实体)
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(筛选出 _TOTAL_ 条数据项)",
